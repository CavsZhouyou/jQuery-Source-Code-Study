 ...
 * @Descriptions: Jquery 源码解读
 * @TodoList: 无
 * @Date: 2018-10-06 09:35:01 
 * @Last Modified by: zhouyou@werun
 * @Last Modified time: 2018-10-06 10:53:05
 */
...
(function (global, factory) {
  ...
  // 如果执行环境为浏览器环境，则传入 window 对象。如果是 node.js 环境则传入 this ，也就是 global 对象
    ...
    init = (jQuery.fn.init = function (selector, context) {
      ...
      if (typeof selector === "string") {
        ...
        return typeof rootjQuery.ready !== "undefined" ?
          rootjQuery.ready(selector) : // Execute immediately if ready is not present
          selector(jQuery);
      }
  ...
  */
  ...
  jQuery.Event = function (src, props) {
    ...
    // 保证对象必须通过 new 操作符创建，保证当前创建的是一个带有 this 实例的对象，因此可以将属性和方法映射到 this 上
    // 在函数里进行判断，实现了 Jquery 的无 new 构建原理 
  ...
  function actualDisplay(name, doc) {
    var style,
      ...
      (style = window.getDefaultComputedStyle(elem[0])) ? // Use of this method is a temporary fix (more like optmization) until something better comes along,
